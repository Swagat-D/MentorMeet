  ...
  const SettingItem = ({ 
    ...
    >
      ...
      <View style={styles.settingRight}>
        {rightComponent}
        {showArrow && <ChevronRight size={getResponsiveValue(16, 18, 20)} color="#9CA3AF" />}
      </View>
    </TouchableOpacity>
  );
    ...
    >
      ...
      {achievement.earned && (
        <View style={styles.achievementEarned}>
          <Trophy size={getResponsiveValue(12, 14, 16)} color="#F59E0B" />
        </View>
      )}
    </TouchableOpacity>
  );
      ...
      >
        ...
        >
          <View style={[
            ...
            <View style={styles.profileSection}>
              ...
              >
                ...
                <View style={styles.cameraIcon}>
                  <Camera size={getResponsiveValue(16, 18, 20)} color="#4F46E5" />
                </View>
              </TouchableOpacity>
            ...
            >
              <Edit3 size={getResponsiveValue(16, 18, 20)} color="#fff" />
        ...
        <View style={[styles.section, { paddingHorizontal: getHorizontalPadding() }]}>
          ...
          <View style={styles.progressCard}>
            <View style={styles.progressHeader}>
              <TrendingUp size={getResponsiveValue(20, 22, 24)} color="#4F46E5" />
        ...
        <View style={[styles.section, { paddingHorizontal: getHorizontalPadding() }]}>
          <TouchableOpacity style={styles.logoutButton} onPress={handleLogout}>
            <LogOut size={getResponsiveValue(20, 22, 24)} color="#EF4444" strokeWidth={2} />
