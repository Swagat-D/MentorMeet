...
import { HelpCircle, MessageCircle, FileText, Mail, Phone, ChevronRight } from "lucide-react-native";
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <HelpCircle size={20} color="#5B8FF9" />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <MessageCircle size={20} color="#5B8FF9" />
